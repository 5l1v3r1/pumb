...
.field public final synthetic h:Landroidx/media/MediaBrowserServiceCompat$n;
...
.method public constructor <init>(Landroidx/media/MediaBrowserServiceCompat$n;Landroidx/media/MediaBrowserServiceCompat$o;Ljava/lang/String;IILandroid/os/Bundle;)V
    ...
    iput-object p3, p0, Landroidx/media/MediaBrowserServiceCompat$n$f;->d:Ljava/lang/String;

    iput p4, p0, Landroidx/media/MediaBrowserServiceCompat$n$f;->e:I
...
.method public run()V
    ...
    invoke-virtual {v1, v0}, Lb/h/g;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    .line 3
    new-instance v1, Landroidx/media/MediaBrowserServiceCompat$f;

    iget-object v2, p0, Landroidx/media/MediaBrowserServiceCompat$n$f;->h:Landroidx/media/MediaBrowserServiceCompat$n;
    ...
    iget v5, p0, Landroidx/media/MediaBrowserServiceCompat$n$f;->e:I

    iget v6, p0, Landroidx/media/MediaBrowserServiceCompat$n$f;->f:I

    iget-object v7, p0, Landroidx/media/MediaBrowserServiceCompat$n$f;->g:Landroid/os/Bundle;

    iget-object v8, p0, Landroidx/media/MediaBrowserServiceCompat$n$f;->c:Landroidx/media/MediaBrowserServiceCompat$o;
    ...
    iget-object v2, v2, Landroidx/media/MediaBrowserServiceCompat;->d:Lb/h/a;

    invoke-virtual {v2, v0, v1}, Lb/h/g;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
