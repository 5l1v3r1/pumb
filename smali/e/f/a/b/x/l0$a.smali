...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Le/f/a/b/x/l0;->b(Ljava/lang/String;[C)Landroidx/lifecycle/LiveData;
.end annotation
...
.field public final synthetic e:Le/f/a/b/x/l0;


# direct methods
.method public constructor <init>(Le/f/a/b/x/l0;Le/f/a/b/t/f/c;[CLjava/lang/String;)V
    .locals 0

    .line 1
    iput-object p1, p0, Le/f/a/b/x/l0$a;->e:Le/f/a/b/x/l0;

    iput-object p3, p0, Le/f/a/b/x/l0$a;->c:[C

    iput-object p4, p0, Le/f/a/b/x/l0$a;->d:Ljava/lang/String;
...
.method public bridge synthetic a(Lcom/fuib/android/spot/data/api/common/ApiResponseData;)V
    ...
    invoke-virtual {p0, p1}, Le/f/a/b/x/l0$a;->a(Lcom/fuib/android/spot/data/api/user/password/set/response/ChangePasswordResponseData;)V
...
.method public a(Lcom/fuib/android/spot/data/api/user/password/set/response/ChangePasswordResponseData;)V
    ...
    .line 2
    iget-object v0, p0, Le/f/a/b/x/l0$a;->e:Le/f/a/b/x/l0;

    invoke-static {v0}, Le/f/a/b/x/l0;->a(Le/f/a/b/x/l0;)Le/f/a/b/t/f/c;
    ...
    iget-object v1, p0, Le/f/a/b/x/l0$a;->c:[C

    iget-object v2, p0, Le/f/a/b/x/l0$a;->d:Ljava/lang/String;

    new-instance v3, Le/f/a/b/x/b;

    invoke-direct {v3, p0, p1, v1, v2}, Le/f/a/b/x/b;-><init>(Le/f/a/b/x/l0$a;Lcom/fuib/android/spot/data/api/user/password/set/response/ChangePasswordResponseData;[CLjava/lang/String;)V
...
.method public synthetic a(Lcom/fuib/android/spot/data/api/user/password/set/response/ChangePasswordResponseData;[CLjava/lang/String;)V
    ...
    invoke-virtual {p1, p2, p3}, Le/f/a/b/t/f/f1$a;->a(Ljava/lang/String;Ljava/lang/String;)V

    return-void

    .line 6
    :cond_0
    iget-object v1, p0, Le/f/a/b/x/l0$a;->e:Le/f/a/b/x/l0;

    invoke-static {v1, p2}, Le/f/a/b/x/l0;->a(Le/f/a/b/x/l0;[C)V

    .line 7
    iget-object p2, p0, Le/f/a/b/x/l0$a;->e:Le/f/a/b/x/l0;

    invoke-virtual {p2, p3}, Le/f/a/b/x/l0;->f(Ljava/lang/String;)V

    .line 8
    iget-object p2, p0, Le/f/a/b/x/l0$a;->e:Le/f/a/b/x/l0;

    invoke-static {p2}, Le/f/a/b/x/l0;->h(Le/f/a/b/x/l0;)Le/f/a/b/t/d/b;

    move-result-object p2

    invoke-virtual {p2, v0}, Le/f/a/b/t/d/b;->c(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p2

    .line 9
    iget-object p3, p0, Le/f/a/b/x/l0$a;->e:Le/f/a/b/x/l0;

    invoke-static {p3}, Le/f/a/b/x/l0;->b(Le/f/a/b/x/l0;)Lcom/fuib/android/spot/data/db/dao/LocalAuthInfoDao;
    ...
    .line 12
    iget-object p1, p0, Le/f/a/b/x/l0$a;->e:Le/f/a/b/x/l0;
...
.method public d()Landroidx/lifecycle/LiveData;
    ...
    invoke-virtual {v0, v1}, Le/f/a/b/t/d/b;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, Le/f/a/b/x/l0;->i(Le/f/a/b/x/l0;)Lcom/fuib/android/spot/data/api/auth/AuthService;
    ...
    iget-object v4, p0, Le/f/a/b/x/l0$a;->c:[C

    invoke-virtual {v3, v4}, Le/f/a/b/w/b/m/e$a;->a([C)Ljava/lang/String;
...
.method public bridge synthetic d(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1}, Le/f/a/b/x/l0$a;->a(Ljava/lang/Boolean;)Z
...
.method public f()Landroidx/lifecycle/LiveData;
    ...
    sget-object v1, Le/f/a/b/x/a;->a:Le/f/a/b/x/a;
