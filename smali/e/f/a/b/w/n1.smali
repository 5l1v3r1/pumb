.class public abstract Le/f/a/b/w/n1;
...
.method public constructor <init>(Le/f/a/b/s/f/c;)V
    ...
    iput-object v0, p0, Le/f/a/b/w/n1;->b:Lb/p/m;

    .line 3
    iput-object p1, p0, Le/f/a/b/w/n1;->a:Le/f/a/b/s/f/c;

    .line 4
    iget-object p1, p0, Le/f/a/b/w/n1;->b:Lb/p/m;
    ...
    .line 5
    invoke-virtual {p0}, Le/f/a/b/w/n1;->d()Landroidx/lifecycle/LiveData;

    move-result-object p1

    .line 6
    iget-object v0, p0, Le/f/a/b/w/n1;->b:Lb/p/m;

    new-instance v1, Le/f/a/b/w/a0;

    invoke-direct {v1, p0, p1}, Le/f/a/b/w/a0;-><init>(Le/f/a/b/w/n1;Landroidx/lifecycle/LiveData;)V
...
.method public final a(Landroidx/lifecycle/LiveData;)V
    ...
    .line 7
    invoke-virtual {p0}, Le/f/a/b/w/n1;->b()Landroidx/lifecycle/LiveData;

    move-result-object v0

    .line 8
    iget-object v1, p0, Le/f/a/b/w/n1;->b:Lb/p/m;

    new-instance v2, Le/f/a/b/w/c0;

    invoke-direct {v2, p0}, Le/f/a/b/w/c0;-><init>(Le/f/a/b/w/n1;)V
    ...
    new-instance v2, Le/f/a/b/w/y;

    invoke-direct {v2, p0, v0, p1}, Le/f/a/b/w/y;-><init>(Le/f/a/b/w/n1;Landroidx/lifecycle/LiveData;Landroidx/lifecycle/LiveData;)V
...
.method public synthetic a(Landroidx/lifecycle/LiveData;Landroidx/lifecycle/LiveData;Lcom/fuib/android/spot/data/api/common/ApiResponse;)V
    ...
    .line 14
    iget-object p1, p0, Le/f/a/b/w/n1;->a:Le/f/a/b/s/f/c;

    invoke-virtual {p1}, Le/f/a/b/s/f/c;->a()Ljava/util/concurrent/Executor;

    move-result-object p1

    new-instance p2, Le/f/a/b/w/x;

    invoke-direct {p2, p0, p3}, Le/f/a/b/w/x;-><init>(Le/f/a/b/w/n1;Lcom/fuib/android/spot/data/api/common/ApiResponse;)V
    ...
    invoke-virtual {p1}, Le/f/a/b/r/e/b$a;->a()V

    .line 16
    invoke-virtual {p0}, Le/f/a/b/w/n1;->e()V

    .line 17
    iget-object p1, p0, Le/f/a/b/w/n1;->b:Lb/p/m;

    new-instance v0, Le/f/a/b/w/z;

    invoke-direct {v0, p0, p3}, Le/f/a/b/w/z;-><init>(Le/f/a/b/w/n1;Lcom/fuib/android/spot/data/api/common/ApiResponse;)V
...
.method public synthetic a(Landroidx/lifecycle/LiveData;Ljava/lang/Object;)V
    ...
    .line 2
    invoke-virtual {p0, p2}, Le/f/a/b/w/n1;->d(Ljava/lang/Object;)Z
    ...
    .line 3
    invoke-virtual {p0, p1}, Le/f/a/b/w/n1;->a(Landroidx/lifecycle/LiveData;)V

    goto :goto_0

    .line 4
    :cond_0
    iget-object p2, p0, Le/f/a/b/w/n1;->b:Lb/p/m;

    new-instance v0, Le/f/a/b/w/b0;

    invoke-direct {v0, p0}, Le/f/a/b/w/b0;-><init>(Le/f/a/b/w/n1;)V
...
.method public synthetic a(Lcom/fuib/android/spot/data/api/common/ApiResponse;)V
    ...
    .line 18
    invoke-virtual {p0, p1}, Le/f/a/b/w/n1;->d(Lcom/fuib/android/spot/data/api/common/ApiResponse;)Lcom/fuib/android/spot/data/api/common/ApiResponseData;

    move-result-object p1

    invoke-virtual {p0, p1}, Le/f/a/b/w/n1;->a(Lcom/fuib/android/spot/data/api/common/ApiResponseData;)V

    .line 19
    iget-object p1, p0, Le/f/a/b/w/n1;->a:Le/f/a/b/s/f/c;

    invoke-virtual {p1}, Le/f/a/b/s/f/c;->c()Ljava/util/concurrent/Executor;

    move-result-object p1

    new-instance v0, Le/f/a/b/w/d0;

    invoke-direct {v0, p0}, Le/f/a/b/w/d0;-><init>(Le/f/a/b/w/n1;)V
...
.method public synthetic a(Lcom/fuib/android/spot/data/api/common/ApiResponse;Ljava/lang/Object;)V
    ...
    .line 20
    invoke-virtual {p0, p1}, Le/f/a/b/w/n1;->b(Lcom/fuib/android/spot/data/api/common/ApiResponse;)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, p1}, Le/f/a/b/w/n1;->c(Lcom/fuib/android/spot/data/api/common/ApiResponse;)I
    ...
    invoke-virtual {p0, p1}, Le/f/a/b/w/n1;->a(Lcom/fuib/android/spot/data/vo/Resource;)V
...
.method public b(Lcom/fuib/android/spot/data/api/common/ApiResponse;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Le/f/a/b/s/f/k1/c$c;->b(Ljava/lang/String;)V
    :try_end_0
...
.method public synthetic c()V
    ...
    new-instance v2, Le/f/a/b/w/w;

    invoke-direct {v2, p0}, Le/f/a/b/w/w;-><init>(Le/f/a/b/w/n1;)V
