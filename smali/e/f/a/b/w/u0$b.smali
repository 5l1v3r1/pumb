.class public final Le/f/a/b/w/u0$b;
.super Le/f/a/b/w/i2;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Le/f/a/b/w/u0;->a(Lcom/fuib/android/spot/data/db/entities/payments/ExchangeAmounts;DLjava/lang/Long;)Landroidx/lifecycle/LiveData;
.end annotation
...
# instance fields
.field public final synthetic d:Le/f/a/b/w/u0;
...
# direct methods
.method public constructor <init>(Le/f/a/b/w/u0;Lcom/fuib/android/spot/data/db/entities/payments/ExchangeAmounts;DLjava/lang/Long;Le/f/a/b/s/f/c;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    iput-object p1, p0, Le/f/a/b/w/u0$b;->d:Le/f/a/b/w/u0;

    iput-object p2, p0, Le/f/a/b/w/u0$b;->e:Lcom/fuib/android/spot/data/db/entities/payments/ExchangeAmounts;

    iput-wide p3, p0, Le/f/a/b/w/u0$b;->f:D

    iput-object p5, p0, Le/f/a/b/w/u0$b;->g:Ljava/lang/Long;

    invoke-direct {p0, p6}, Le/f/a/b/w/i2;-><init>(Le/f/a/b/s/f/c;)V
...
.method public a(Lcom/fuib/android/spot/data/api/transfer/cexchange/response/PreCalculateCurrencyExchangeResponseData;)Lcom/fuib/android/spot/data/db/entities/payments/ExchangeAmounts;
    ...
    .line 1
    iget-object v1, v0, Le/f/a/b/w/u0$b;->e:Lcom/fuib/android/spot/data/db/entities/payments/ExchangeAmounts;
    ...
    .line 2
    iget-object v2, v0, Le/f/a/b/w/u0$b;->e:Lcom/fuib/android/spot/data/db/entities/payments/ExchangeAmounts;
    ...
    .line 5
    iget-object v5, v0, Le/f/a/b/w/u0$b;->e:Lcom/fuib/android/spot/data/db/entities/payments/ExchangeAmounts;
...
.method public b()Landroidx/lifecycle/LiveData;
    ...
    .line 2
    iget-object v0, p0, Le/f/a/b/w/u0$b;->d:Le/f/a/b/w/u0;

    invoke-static {v0}, Le/f/a/b/w/u0;->d(Le/f/a/b/w/u0;)Lcom/fuib/android/spot/data/api/transfer/cexchange/CurrencyExchangeService;

    move-result-object v0

    iget-object v1, p0, Le/f/a/b/w/u0$b;->e:Lcom/fuib/android/spot/data/db/entities/payments/ExchangeAmounts;
    ...
    .line 3
    iget-object v2, p0, Le/f/a/b/w/u0$b;->e:Lcom/fuib/android/spot/data/db/entities/payments/ExchangeAmounts;
    ...
    .line 5
    iget-object v3, p0, Le/f/a/b/w/u0$b;->e:Lcom/fuib/android/spot/data/db/entities/payments/ExchangeAmounts;
    ...
    .line 8
    iget-wide v6, p0, Le/f/a/b/w/u0$b;->f:D

    .line 9
    iget-object v8, p0, Le/f/a/b/w/u0$b;->g:Ljava/lang/Long;
...
.method public bridge synthetic b(Lcom/fuib/android/spot/data/api/common/ApiResponseData;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Le/f/a/b/w/u0$b;->a(Lcom/fuib/android/spot/data/api/transfer/cexchange/response/PreCalculateCurrencyExchangeResponseData;)Lcom/fuib/android/spot/data/db/entities/payments/ExchangeAmounts;
