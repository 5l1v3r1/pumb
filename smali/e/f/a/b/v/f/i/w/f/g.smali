.class public final Le/f/a/b/v/f/i/w/f/g;
...
# static fields
.field public static final d:Le/f/a/b/v/f/i/w/f/g$a;
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Le/f/a/b/v/f/i/w/f/g$a;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Le/f/a/b/v/f/i/w/f/g$a;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, Le/f/a/b/v/f/i/w/f/g;->d:Le/f/a/b/v/f/i/w/f/g$a;

    return-void
.end method

.method public constructor <init>(Le/f/a/b/v/f/i/w/f/c;Lcom/fuib/android/spot/data/db/entities/paymentToReceiver/PTRLoan;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Le/f/a/b/v/f/i/w/f/g;->b:Le/f/a/b/v/f/i/w/f/c;

    iput-object p2, p0, Le/f/a/b/v/f/i/w/f/g;->c:Lcom/fuib/android/spot/data/db/entities/paymentToReceiver/PTRLoan;

    return-void
.end method

.method public synthetic constructor <init>(Le/f/a/b/v/f/i/w/f/c;Lcom/fuib/android/spot/data/db/entities/paymentToReceiver/PTRLoan;Lkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0

    .line 2
    invoke-direct {p0, p1, p2}, Le/f/a/b/v/f/i/w/f/g;-><init>(Le/f/a/b/v/f/i/w/f/c;Lcom/fuib/android/spot/data/db/entities/paymentToReceiver/PTRLoan;)V
...
.method public a(Lcom/fuib/android/spot/presentation/common/widget/TransferItemView;)V
    ...
    .line 4
    invoke-virtual {p0}, Le/f/a/b/v/f/i/w/f/g;->a()Le/f/a/b/v/b/e/c;

    move-result-object v0

    .line 5
    iget-object v1, p0, Le/f/a/b/v/f/i/w/f/g;->b:Le/f/a/b/v/f/i/w/f/c;

    invoke-virtual {v1}, Le/f/a/b/v/f/i/w/f/c;->b()Ljava/lang/String;
    ...
    .line 6
    iget-object v2, p0, Le/f/a/b/v/f/i/w/f/g;->c:Lcom/fuib/android/spot/data/db/entities/paymentToReceiver/PTRLoan;
    ...
    .line 7
    :goto_0
    iget-object v3, p0, Le/f/a/b/v/f/i/w/f/g;->c:Lcom/fuib/android/spot/data/db/entities/paymentToReceiver/PTRLoan;
    ...
    .line 8
    invoke-virtual {p1, v0, v1, v2, v3}, Lcom/fuib/android/spot/presentation/common/widget/TransferItemView;->a(Le/f/a/b/v/b/e/c;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Long;)V
...
.method public bridge synthetic a(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Le/f/a/b/v/f/i/w/f/g;->a(Lcom/fuib/android/spot/presentation/common/widget/TransferItemView;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    instance-of v0, p1, Le/f/a/b/v/f/i/w/f/g;

    if-eqz v0, :cond_0

    check-cast p1, Le/f/a/b/v/f/i/w/f/g;

    iget-object v0, p0, Le/f/a/b/v/f/i/w/f/g;->b:Le/f/a/b/v/f/i/w/f/c;

    iget-object v1, p1, Le/f/a/b/v/f/i/w/f/g;->b:Le/f/a/b/v/f/i/w/f/c;
    ...
    iget-object v0, p0, Le/f/a/b/v/f/i/w/f/g;->c:Lcom/fuib/android/spot/data/db/entities/paymentToReceiver/PTRLoan;

    iget-object p1, p1, Le/f/a/b/v/f/i/w/f/g;->c:Lcom/fuib/android/spot/data/db/entities/paymentToReceiver/PTRLoan;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Le/f/a/b/v/f/i/w/f/g;->c:Lcom/fuib/android/spot/data/db/entities/paymentToReceiver/PTRLoan;
