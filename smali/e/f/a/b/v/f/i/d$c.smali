.class public Le/f/a/b/v/f/i/d$c;
...
# direct methods
.method public constructor <init>(Le/f/a/b/v/f/i/d;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()V"
...
.method public a()Le/f/a/b/v/b/o/t/i;
    ...
    .line 3
    new-instance v0, Le/f/a/b/v/b/o/t/b;

    invoke-direct {v0}, Le/f/a/b/v/b/o/t/b;-><init>()V

    return-object v0
.end method

.method public a(Landroid/content/Context;Le/f/a/b/v/b/e/c;Le/f/a/b/v/f/e/m/k/z;)Le/f/a/b/v/f/i/y/b;
    .locals 10

    .line 4
    instance-of v0, p3, Le/f/a/b/v/f/e/m/k/a;

    if-eqz v0, :cond_0

    .line 5
    sget-object v1, Le/f/a/b/v/f/i/y/b;->f:Le/f/a/b/v/f/i/y/b$a;

    sget-object v0, Lcom/fuib/android/spot/data/vo/AccountType;->Companion:Lcom/fuib/android/spot/data/vo/AccountType$Companion;

    check-cast p3, Le/f/a/b/v/f/e/m/k/a;

    invoke-virtual {p3}, Le/f/a/b/v/f/e/m/k/a;->o()Lcom/fuib/android/spot/data/db/entities/Account;
    ...
    .line 6
    invoke-interface {p3}, Le/f/a/b/v/f/e/m/k/y;->j()Lcom/fuib/android/spot/data/db/entities/card/Card;
    ...
    .line 7
    invoke-virtual/range {v1 .. v9}, Le/f/a/b/v/f/i/y/b$a;->a(Landroid/content/Context;Le/f/a/b/v/b/e/c;Lcom/fuib/android/spot/data/vo/AccountType;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;)Le/f/a/b/v/f/i/y/b;
...
.method public bridge synthetic a(Landroid/content/Context;Le/f/a/b/v/b/e/c;Le/f/a/b/v/f/e/m/k/z;)Ljava/lang/Object;
    ...
    .line 2
    invoke-virtual {p0, p1, p2, p3}, Le/f/a/b/v/f/i/d$c;->a(Landroid/content/Context;Le/f/a/b/v/b/e/c;Le/f/a/b/v/f/e/m/k/z;)Le/f/a/b/v/f/i/y/b;
