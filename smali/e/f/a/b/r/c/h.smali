.class public final Le/f/a/b/r/c/h;
...
# direct methods
.method public constructor <init>(Le/f/a/b/s/f/c;Lcom/fuib/android/spot/data/api/user/LoginConfigurationService;Lcom/fuib/android/spot/data/db/dao/LocalAuthInfoDao;Lkotlin/jvm/functions/Function1;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Le/f/a/b/r/c/h;->k:Lcom/fuib/android/spot/data/api/user/LoginConfigurationService;

    iput-object p3, p0, Le/f/a/b/r/c/h;->l:Lcom/fuib/android/spot/data/db/dao/LocalAuthInfoDao;

    .line 2
    invoke-virtual {p0, p4}, Le/f/a/b/r/c/a;->b(Lkotlin/jvm/functions/Function1;)V

    return-void
.end method

.method public static final synthetic a(Le/f/a/b/r/c/h;)Lcom/fuib/android/spot/data/api/user/LoginConfigurationService;
    .locals 0

    .line 1
    iget-object p0, p0, Le/f/a/b/r/c/h;->k:Lcom/fuib/android/spot/data/api/user/LoginConfigurationService;

    return-object p0
.end method

.method public static final synthetic a(Le/f/a/b/r/c/h;Z)V
    .locals 0

    .line 2
    invoke-virtual {p0, p1}, Le/f/a/b/r/c/h;->a(Z)V
...
# virtual methods
.method public a(Lcom/fuib/android/spot/data/api/user/credentials/all/set/response/ValidateSetPinTouchResponseData;)Le/f/a/b/r/c/d$a;
    .locals 1
...
.method public bridge synthetic a(Lcom/fuib/android/spot/data/api/common/ApiResponseData;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Le/f/a/b/r/c/h;->a(Lcom/fuib/android/spot/data/api/user/credentials/all/set/response/ValidateSetPinTouchResponseData;)Le/f/a/b/r/c/d$a;
...
.method public final a(Z)V
    ...
    .line 5
    iget-object v0, p0, Le/f/a/b/r/c/h;->l:Lcom/fuib/android/spot/data/db/dao/LocalAuthInfoDao;
...
.method public bridge synthetic b(Lcom/fuib/android/spot/data/api/common/ApiResponseData;)Ljava/lang/Boolean;
    ...
    invoke-virtual {p0, p1}, Le/f/a/b/r/c/h;->b(Lcom/fuib/android/spot/data/api/user/credentials/all/set/response/ValidateSetPinTouchResponseData;)Ljava/lang/Boolean;
...
.method public j()Lkotlin/jvm/functions/Function1;
    ...
    .line 1
    new-instance v0, Le/f/a/b/r/c/h$a;

    invoke-direct {v0, p0}, Le/f/a/b/r/c/h$a;-><init>(Le/f/a/b/r/c/h;)V
...
.method public n()Lkotlin/jvm/functions/Function1;
    ...
    .line 1
    new-instance v0, Le/f/a/b/r/c/h$b;

    invoke-direct {v0, p0}, Le/f/a/b/r/c/h$b;-><init>(Le/f/a/b/r/c/h;)V
