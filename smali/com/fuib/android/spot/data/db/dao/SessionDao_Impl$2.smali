.class public Lcom/fuib/android/spot/data/db/dao/SessionDao_Impl$2;
.super Lb/u/b;
...
.method public constructor <init>(Lcom/fuib/android/spot/data/db/dao/SessionDao_Impl;Lb/u/f;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/fuib/android/spot/data/db/dao/SessionDao_Impl$2;->this$0:Lcom/fuib/android/spot/data/db/dao/SessionDao_Impl;
...
.method public bind(Lb/w/a/f;Lcom/fuib/android/spot/data/db/entities/Session;)V
    ...
    .line 15
    :goto_3
    iget-object v0, p0, Lcom/fuib/android/spot/data/db/dao/SessionDao_Impl$2;->this$0:Lcom/fuib/android/spot/data/db/dao/SessionDao_Impl;
    ...
    .line 28
    iget-boolean v0, p2, Lcom/fuib/android/spot/data/db/entities/Session;->isBlockSuggestTouchEnter:Z
    ...
    .line 30
    iget-wide v1, p2, Lcom/fuib/android/spot/data/db/entities/Session;->id:J
...
.method public bridge synthetic bind(Lb/w/a/f;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/fuib/android/spot/data/db/dao/SessionDao_Impl$2;->bind(Lb/w/a/f;Lcom/fuib/android/spot/data/db/entities/Session;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `session` SET `id` = ?,`udid` = ?,`phone` = ?,`psw` = ?,`authKey` = ?,`authType` = ?,`jwt` = ?,`pin` = ?,`isTouch` = ?,`hasFpSensor` = ?,`isBlockSuggestTouchEnter` = ? WHERE `id` = ?"
