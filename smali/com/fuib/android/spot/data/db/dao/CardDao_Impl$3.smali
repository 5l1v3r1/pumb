.class public Lcom/fuib/android/spot/data/db/dao/CardDao_Impl$3;
.super Lb/u/b;
...
.method public constructor <init>(Lcom/fuib/android/spot/data/db/dao/CardDao_Impl;Lb/u/f;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/fuib/android/spot/data/db/dao/CardDao_Impl$3;->this$0:Lcom/fuib/android/spot/data/db/dao/CardDao_Impl;
...
.method public bind(Lb/w/a/f;Lcom/fuib/android/spot/data/db/entities/card/Card;)V
    ...
    .line 15
    :goto_3
    iget-object v0, p0, Lcom/fuib/android/spot/data/db/dao/CardDao_Impl$3;->this$0:Lcom/fuib/android/spot/data/db/dao/CardDao_Impl;

    invoke-static {v0}, Lcom/fuib/android/spot/data/db/dao/CardDao_Impl;->access$000(Lcom/fuib/android/spot/data/db/dao/CardDao_Impl;)Lcom/fuib/android/spot/data/db/entities/EnumConverter;
...
.method public bridge synthetic bind(Lb/w/a/f;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/fuib/android/spot/data/db/dao/CardDao_Impl$3;->bind(Lb/w/a/f;Lcom/fuib/android/spot/data/db/entities/card/Card;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `card` SET `card_id` = ?,`account_id` = ?,`embossingName` = ?,`expirationDate` = ?,`number` = ?,`status` = ?,`type` = ? WHERE `card_id` = ?"
