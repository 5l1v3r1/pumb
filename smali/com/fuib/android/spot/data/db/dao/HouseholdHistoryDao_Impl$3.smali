.class public Lcom/fuib/android/spot/data/db/dao/HouseholdHistoryDao_Impl$3;
.super Lb/u/b;
...
.method public constructor <init>(Lcom/fuib/android/spot/data/db/dao/HouseholdHistoryDao_Impl;Lb/u/f;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/fuib/android/spot/data/db/dao/HouseholdHistoryDao_Impl$3;->this$0:Lcom/fuib/android/spot/data/db/dao/HouseholdHistoryDao_Impl;
...
.method public bind(Lb/w/a/f;Lcom/fuib/android/spot/data/db/entities/services/HouseholdHistoryItem;)V
    ...
    .line 8
    :goto_1
    iget-object v0, p0, Lcom/fuib/android/spot/data/db/dao/HouseholdHistoryDao_Impl$3;->this$0:Lcom/fuib/android/spot/data/db/dao/HouseholdHistoryDao_Impl;
...
.method public bridge synthetic bind(Lb/w/a/f;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/fuib/android/spot/data/db/dao/HouseholdHistoryDao_Impl$3;->bind(Lb/w/a/f;Lcom/fuib/android/spot/data/db/entities/services/HouseholdHistoryItem;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR IGNORE `hh_history_item` SET `operation_id` = ?,`status` = ?,`date` = ?,`amount` = ?,`commission` = ?,`service_id` = ?,`service_name` = ? WHERE `operation_id` = ?"
