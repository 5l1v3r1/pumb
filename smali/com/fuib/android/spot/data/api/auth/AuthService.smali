...
# instance fields
.field public appTypeProvider:Le/f/a/b/s/f/g;

.field public launchTypeProvider:Le/f/a/b/s/f/o0;

.field public versionProvider:Lcom/fuib/android/spot/data/api/common/AppVersionProvider;


# direct methods
.method public constructor <init>(Lcom/fuib/android/spot/data/api/common/AppLocaleProvider;Lcom/fuib/android/spot/data/api/common/ServiceEndpoint;Lcom/fuib/android/spot/data/api/common/AppVersionProvider;Le/f/a/b/s/f/g;Le/f/a/b/s/f/c1;Le/f/a/b/s/f/c0;Le/f/a/b/s/f/o0;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p5, p6}, Lcom/fuib/android/spot/data/api/common/AbstractService;-><init>(Lcom/fuib/android/spot/data/api/common/AppLocaleProvider;Lcom/fuib/android/spot/data/api/common/ServiceEndpoint;Le/f/a/b/s/f/c1;Le/f/a/b/s/f/c0;)V
    ...
    .line 3
    iput-object p4, p0, Lcom/fuib/android/spot/data/api/auth/AuthService;->appTypeProvider:Le/f/a/b/s/f/g;

    .line 4
    iput-object p7, p0, Lcom/fuib/android/spot/data/api/auth/AuthService;->launchTypeProvider:Le/f/a/b/s/f/o0;
...
.method public auth(Ljava/lang/String;[CZZLjava/lang/Integer;)Landroidx/lifecycle/LiveData;
    ...
    sget-object v0, Le/f/a/b/v/b/m/e;->a:Le/f/a/b/v/b/m/e$a;

    .line 2
    invoke-virtual {v0, p2}, Le/f/a/b/v/b/m/e$a;->a([C)Ljava/lang/String;
    ...
    iget-object p2, p0, Lcom/fuib/android/spot/data/api/auth/AuthService;->appTypeProvider:Le/f/a/b/s/f/g;

    .line 4
    invoke-interface {p2}, Le/f/a/b/s/f/g;->a()Le/f/a/b/s/f/e;

    move-result-object v7

    iget-object p2, p0, Lcom/fuib/android/spot/data/api/auth/AuthService;->launchTypeProvider:Le/f/a/b/s/f/o0;

    .line 5
    invoke-interface {p2}, Le/f/a/b/s/f/o0;->a()Le/f/a/b/s/f/m0;

    move-result-object p2

    invoke-virtual {p2}, Le/f/a/b/s/f/m0;->a()Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v8}, Lcom/fuib/android/spot/data/api/auth/pasword/request/AuthPassRequest;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLjava/lang/Integer;Ljava/lang/String;Le/f/a/b/s/f/e;Ljava/lang/String;)V
    ...
    new-instance p2, Le/f/a/b/s/b/a/e;

    invoke-direct {p2, p0}, Le/f/a/b/s/b/a/e;-><init>(Lcom/fuib/android/spot/data/api/auth/AuthService;)V
...
.method public authPin(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLjava/lang/Integer;)Landroidx/lifecycle/LiveData;
    ...
    iget-object v0, p0, Lcom/fuib/android/spot/data/api/auth/AuthService;->appTypeProvider:Le/f/a/b/s/f/g;
    ...
    iget-object v0, p0, Lcom/fuib/android/spot/data/api/auth/AuthService;->launchTypeProvider:Le/f/a/b/s/f/o0;

    .line 4
    invoke-interface {v0}, Le/f/a/b/s/f/o0;->a()Le/f/a/b/s/f/m0;

    move-result-object v0

    invoke-virtual {v0}, Le/f/a/b/s/f/m0;->a()Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v8}, Lcom/fuib/android/spot/data/api/auth/pin/request/EnterPinRequest;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLjava/lang/Integer;Ljava/lang/String;Le/f/a/b/s/f/e;Ljava/lang/String;)V
    ...
    new-instance p2, Le/f/a/b/s/b/a/d;

    invoke-direct {p2, p0}, Le/f/a/b/s/b/a/d;-><init>(Lcom/fuib/android/spot/data/api/auth/AuthService;)V
...
.method public authTouch(Ljava/lang/String;Ljava/lang/String;ZLjava/lang/Integer;)Landroidx/lifecycle/LiveData;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/fuib/android/spot/data/api/auth/touch/request/EnterTouchRequest;-><init>(Ljava/lang/String;Ljava/lang/String;ZLjava/lang/Integer;Ljava/lang/String;Le/f/a/b/s/f/e;Ljava/lang/String;)V
    ...
    new-instance p2, Le/f/a/b/s/b/a/b;

    invoke-direct {p2, p0}, Le/f/a/b/s/b/a/b;-><init>(Lcom/fuib/android/spot/data/api/auth/AuthService;)V
...
.method public changePassword(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroidx/lifecycle/LiveData;
    ...
    new-instance p2, Le/f/a/b/s/b/a/c;

    invoke-direct {p2, p0}, Le/f/a/b/s/b/a/c;-><init>(Lcom/fuib/android/spot/data/api/auth/AuthService;)V
...
.method public setCredentials(Lcom/fuib/android/spot/data/db/entities/Session;Lcom/fuib/android/spot/data/vo/CorezoidButtonId;)Landroidx/lifecycle/LiveData;
    ...
    new-instance p2, Le/f/a/b/s/b/a/a;

    invoke-direct {p2, p0}, Le/f/a/b/s/b/a/a;-><init>(Lcom/fuib/android/spot/data/api/auth/AuthService;)V
