...
# instance fields
.field public logFile:Li/a/a/a/m/b/u;
...
.method private doWriteToLog(JLjava/lang/String;)V
    ...
    .line 1
    iget-object v1, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Li/a/a/a/m/b/u;
    ...
    .line 9
    iget-object p2, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Li/a/a/a/m/b/u;

    invoke-virtual {p2, p1}, Li/a/a/a/m/b/u;->a([B)V

    .line 10
    :goto_0
    iget-object p1, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Li/a/a/a/m/b/u;

    invoke-virtual {p1}, Li/a/a/a/m/b/u;->b()Z
    ...
    invoke-virtual {p1}, Li/a/a/a/m/b/u;->f()I
    ...
    invoke-virtual {p1}, Li/a/a/a/m/b/u;->e()V
    :try_end_0
    ...
    invoke-interface {p2, p3, v0, p1}, Li/a/a/a/k;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private getLogBytes()Lcom/crashlytics/android/core/QueueFileLogStore$LogBytes;
    ...
    .line 3
    iget-object v0, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Li/a/a/a/m/b/u;
    ...
    .line 5
    :try_start_0
    iget-object v3, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Li/a/a/a/m/b/u;
    ...
    invoke-virtual {v3, v4}, Li/a/a/a/m/b/u;->a(Li/a/a/a/m/b/u$d;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {v4, v5, v6, v3}, Li/a/a/a/k;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private openLogFile()V
    ...
    .line 2
    :try_start_0
    new-instance v0, Li/a/a/a/m/b/u;

    iget-object v1, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->workingFile:Ljava/io/File;

    invoke-direct {v0, v1}, Li/a/a/a/m/b/u;-><init>(Ljava/io/File;)V

    iput-object v0, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Li/a/a/a/m/b/u;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {v1, v3, v2, v0}, Li/a/a/a/k;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public closeLogFile()V
    ...
    invoke-static {v0, v1}, Li/a/a/a/m/b/i;->a(Ljava/io/Closeable;Ljava/lang/String;)V
