...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/transitionseverywhere/ChangeImageTransform;->K:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/transitionseverywhere/ChangeImageTransform;->L:Landroid/util/Property;
...
.method public a(Landroid/view/ViewGroup;Le/m/j;Le/m/j;)Landroid/animation/Animator;
    ...
    .line 12
    sget-object p2, Le/m/n/d;->a:Landroid/graphics/Matrix;

    :cond_7
    if-nez v2, :cond_8

    .line 13
    sget-object v2, Le/m/n/d;->a:Landroid/graphics/Matrix;

    .line 14
    :cond_8
    invoke-static {p1, p2}, Le/m/n/d;->a(Landroid/widget/ImageView;Landroid/graphics/Matrix;)V

    .line 15
    new-instance p3, Le/m/n/d$b;

    invoke-direct {p3}, Le/m/n/d$b;-><init>()V

    invoke-virtual {p0, p1, p3, p2, v2}, Lcom/transitionseverywhere/ChangeImageTransform;->a(Landroid/widget/ImageView;Landroid/animation/TypeEvaluator;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    ...
    :cond_9
    :goto_1
    new-instance p2, Le/m/n/d$c;

    invoke-direct {p2}, Le/m/n/d$c;-><init>()V

    sget-object p3, Le/m/n/d;->a:Landroid/graphics/Matrix;

    invoke-virtual {p0, p1, p2, p3, p3}, Lcom/transitionseverywhere/ChangeImageTransform;->a(Landroid/widget/ImageView;Landroid/animation/TypeEvaluator;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
...
.method public final a(Landroid/widget/ImageView;Landroid/animation/TypeEvaluator;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 17
    sget-object v0, Lcom/transitionseverywhere/ChangeImageTransform;->L:Landroid/util/Property;
...
.method public a(Le/m/j;)V
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/transitionseverywhere/ChangeImageTransform;->d(Le/m/j;)V
...
.method public h()[Ljava/lang/String;
    ...
    .line 1
    sget-object v0, Lcom/transitionseverywhere/ChangeImageTransform;->K:[Ljava/lang/String;
